...
import { IconBus, IconMapPin, IconShoppingCart, IconTrain } from '@tabler/icons-react';
        ...
        <Container size="lg" className={classes.container}>
          ...
          <div className={classes.content}>
              ...
              <Button
                ...
                href="https://goo.gl/maps/UfzENMSXfo8C3DNt9"
                leftIcon={<IconMapPin />} radius="md" size="md" className={classes.control}>
                Juhised
              </Button>
            </div>
          </div>
